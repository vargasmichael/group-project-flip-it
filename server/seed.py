...
with app.app_context():
    ...
    p1 = Player(username = 'Dylan', _password_hash = 'null', player_image = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4JZfpQ6mVj8ln6iivtg2ozj3BlLfD4aXRZg&usqp=CAU', total_wins = 12, total_games = 100)
    p2 = Player(username = 'Ben', _password_hash = 'null', player_image = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfUpKuFE2IyiOg93GdJfY7YL0iXGnRfdkBHw&usqp=CAU', total_wins = 10, total_games = 100)
    p3 = Player(username = 'Abby', _password_hash = 'null', player_image = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNECPASq1pw7Xma3LjngqyS0438ZWubBT6_A&usqp=CAU', total_wins = 20, total_games = 100)
    p4 = Player(username = "Michael", _password_hash = 'null', player_image = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRj8dNYETUxRctek5phC5h1RuPnyybW21FpqQ&usqp=CAU', total_wins = 100, total_games = 100)
    players = [p1, p2, p3, p4]
